...
<label for="check" class="checkbtn">
    ...
    <center>
        ...
        <h1 class="deposito">Adicionar Fundos a partir de:</h1>
...
<a href="depositos.php"><button class="registros">Depósitos/Saques</button></a>
        </div>
        <br>
...
<center><br>
        <h4 class="carteiras">Nossos endereços de carteiras</h4>
        ...
        <div class="depositar">
            <p class="endereco" id="endereco">Endereço PayPal</p>
                <label for="endereco">
            <input type="text" class="inputt" name="enderecoLocal" value="animuconsultoria@gmail.com" id="">
        </label>
    
        <br>
        
        <p class="endereco" id="endereco">Endereço Perfect Money</p>
        <label for="endereco">
    <input type="text" class="inputt" name="enderecoLocal"  value="animuconsultoria@gmail.com" id="">
</label>
...
<p class="endereco" id="endereco">Endereço AirTM</p>
<label for="endereco">
<input type="text" class="inputt" name="enderecoLocal"  value="animuconsultoria@gmail.com" id="">
</label>
...
<p class="endereco" id="enderecot">Endereço Payoneer</p>
<label for="endereco">
<input type="text" class="inputt" name="enderecoLocal"  value="animuconsultoria@gmail.com" id="">
</label>
