...
<hr>
    <center>
     ...
     <center>
         <form action="concluir_saque.php" method="get">
<?php
...
?>
        ...
        <input type="hidden" name="carteira_origem" value="<?=$acao?>">
             Quantidade que deseja sacar ( $ ) : <br><br>
             <input required type="number" value="<?=$quantidade?>" id="input" placeholder="  <?=$quantidade?> " name="quantidade" id="quantidade" max-lenght="5" required><br>
          <br>
          <p >Titular: <b class="titular"> <?=$titular?></b></p>
          <p >IBAN: <b class="titular"><?=$iban?></b></p>
